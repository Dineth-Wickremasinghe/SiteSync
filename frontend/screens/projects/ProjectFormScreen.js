...
export default function ProjectFormScreen({ route, navigation }) {
  ...
  const [imageUri,    setImageUri]    = useState(existingProject?.blueprintImage || null)
...
const styles = StyleSheet.create({
  ...
  changePhotoOverlay: {
    ...
    backgroundColor: 'rgba(27,67,50,0.55)', paddingVertical: 6, alignItems: 'center',
  },
  ...
  statusChip: {
    ...
    borderWidth: 1.5, borderColor: '#C8DEC9',
