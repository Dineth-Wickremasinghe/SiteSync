...
export default function ProjectDetailScreen({ route, navigation }) {
  ...
  const createdAt   = new Date(project.createdAt).toLocaleDateString('en-GB', {
...
const styles = StyleSheet.create({
  ...
  projectTitle: {
    fontSize: 26, fontWeight: '800', color: '#1B2B1E',
  ...
  editBtn: {
    ...
    elevation: 3, shadowColor: '#1B4332',
    shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.25, shadowRadius: 6,
  },
  editBtnText:   { color: '#FFFFFF', fontSize: 16, fontWeight: '700' },
  deleteBtn:     {
    backgroundColor: '#FFF0F0', borderRadius: 14, paddingVertical: 14,
    alignItems: 'center', borderWidth: 1.5, borderColor: '#FFCDD2',
  },
